...
import { insertBlogPostSchema, type InsertBlogPost, type AIWritingRequest } from '@shared/schema';
...
export default function WritePost() {
  ...
  async function onSubmit(data: InsertBlogPost) {
    if (!user) {
      toast({
        ...
        description: 'Please login to publish posts.',
        variant: 'destructive',
      });
      return;
    }
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Write a New Post</h1>
          <p className="text-muted-foreground">
            Create your story with AI-powered writing assistance
          </p>
        </div>
              ...
              <CardContent className="space-y-4">
                ...
                {!aiSuggestion && !isAiLoading && (
                  <div className="text-center py-8 text-sm text-muted-foreground">
                    ...
                    <p>Write some content, then use AI to enhance it</p>
                  </div>
                )}
              </CardContent>
            </Card>
