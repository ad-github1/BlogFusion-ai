...
- **Secure Authentication**: User accounts powered by JWT and bcryptjs for safe, encrypted logins.
- **Personal Dashboard**: Manage your posts, edit, or delete with a click.
- **Explore & Connect**: Browse community posts, discover new authors, and get inspired!
- **Rich Markdown Support**: Write with style and see your posts rendered beautifully.
...
3. **Set up environment variables:**
   ...
   - Add your [OpenAI API key](https://platform.openai.com/) and database URI:
     ```
